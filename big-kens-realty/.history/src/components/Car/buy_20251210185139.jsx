...
export default function SimpleBuySection() {
  ...
  return (
    <section className="py-20 bg-[#0A1023] text-white text-center">
      ...
      {/* Background Section */}
      <div
        className="relative w-full bg-cover bg-center bg-no-repeat rounded-xl py-24 px-6"
      ...
      >
        <div className="grid md:grid-cols-3 gap-8 text-center">
          {steps.map((step, i) => (
            <div key={i}>
              {/* Icon Box */}
              <div className="bg-[#C8FFD4] w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                {step.icon}
              </div>
