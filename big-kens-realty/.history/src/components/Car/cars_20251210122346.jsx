...
import car2 from "../../assets/car/car2.";
import car3 from "../../assets/car/car3.";
  ...
  return (
    <section className="py-20 bg-[#0A1023] text-white">
      ...
      <div className="grid md:grid-cols-3 gap-8 px-6 md:px-20">
        {cars.map((car, i) => (
          <div key={i} className="bg-[#10162A] p-4 rounded-lg shadow">
            <img src={car.img} className="rounded-lg mb-4" alt="" />
            <h3 className="font-bold">{car.name}</h3>
            <p className="text-lg text-[#C8FFD4]">{car.price}</p>
