          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={handleInputChange}
                className="w-full border-2 border-[#1A1941]/40 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1A1941]/70 focus:border-[#1A1941] transition-all duration-300 pl-10 text-[#1A1941] bg-white/90"
              />
              <div className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#1A1941]/70">
                <span>₦</span>
              </div>
            </div>
            <div className="text-xs text-[#1A1941] font-medium">Min: {searchData.minPrice}m</div>
          </div>
