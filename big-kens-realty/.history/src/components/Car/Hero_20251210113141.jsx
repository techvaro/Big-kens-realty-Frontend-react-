...
export default function HeroSearchSection() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-[#1A1941] to-[#3a3951] pb-16 overflow-hidden">
      ...
      {/* Enhanced Search Box */}
      <div className="bg-gradient-to-b from-white to-[#f8f8f0] w-11/12 md:w-4/5 mx-auto mt-[-60px] p-8 rounded-2xl shadow-2xl z-10 relative border border-[#1A1941]/20">
