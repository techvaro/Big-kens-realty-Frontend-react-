...
export default function HeroSearchSection() {
  ...
  return (
    <section className="relative bg-[#0A1023] pb-10">
      {/* Hero Image */}
      ...
      {/* Search Box */}
      <div className="bg-white w-11/12 md:w-4/5 mx-auto mt-[-60px] p-6 rounded-xl shadow-2xl z-10 relative">
        <form onSubmit={handleSubmit} className="grid md:grid-cols-5 gap-4 items-end">
          ...
          <div className="space-y-2 col-span-1">
            ...
            <input
              ...
              className="w-full border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
            />
            <div className="text-xs text-gray-600">Min: {searchData.minPrice}m</div>
          </div>
          ...
          <div className="space-y-2 col-span-1">
            ...
            <input
              ...
              className="w-full border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
            />
            <div className="text-xs text-gray-600">Max: {searchData.maxPrice}m</div>
          </div>

          {/* Search Button */}
          <div className="pb-1 col-span-1">
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-700 to-blue-900 hover:from-blue-800 hover:to-blue-950 text-white py-3 rounded-lg font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
            >
              Search
            </button>
          </div>
