...
import project1 from "../../assets/music/proj1.jpg";
import project2 from "../../assets/music/proj2.jpg";
import project3 from "../../assets/music/proj3.jpg";
import project4 from "../../assets/music/proj4.jpg";
...
export default function Projects() {
  return (
    <section id="portfolio" className="py-20 px-6 md:px-20 bg-[#CAFFD3]">
