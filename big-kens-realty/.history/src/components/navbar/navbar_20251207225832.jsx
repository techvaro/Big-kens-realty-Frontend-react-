...
export default function Navbar() {
  ...
  return (
    <div>
        <nav className="hidden lg:flex items-center justify-between px-60 py-5 bg-[#0c0e28] sticky top-0 z-50">
            <span className="inline-flex items-center justify-left gap-3">
        ...
        <nav className="flex lg:hidden items-center justify-between px-7 py-5 bg-[#0c0e28] sticky top-0 z-50">
            <span className="inline-flex items-center justify-center gap-3">
                <img src={logo} className="h-10 w-10" alt="Big Ken Enterprises Logo" />
                <span className="text-xl font-bold text-white">Big Ken Enterprises</span>
            </span>
